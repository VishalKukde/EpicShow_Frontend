...
export default function RefundHero() {
  ...
  return (
    <section
      className={`rounded-3xl border p-6 text-white shadow-lg sm:p-8 ${dark
    ...
    >
      ...
      <h1 className="mt-2 text-2xl font-semibold sm:text-3xl dark:text-white">Manage your refunds and credits</h1>
      <p className={`mt-2 max-w-xl text-sm ${dark ? "text-zinc-400" : "text-gray-400"} dark:text-zinc-400`}>
