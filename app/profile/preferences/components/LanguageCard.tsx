        ...
        {languageOptions.map((option) => {
          ...
          return (
            <button
              ...
              className={`flex w-full items-center justify-between rounded-xl border px-3 py-2.5 text-sm transition sm:px-4 ${selected
                  ? dark
            ...
            >
              ...
              <span
                className={`rounded-full px-2 py-0.5 text-[10px] font-semibold uppercase ${option.enabled
                    ? dark
