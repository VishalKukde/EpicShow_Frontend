...
export default function ProfileNavbar() {
  ...
  const developerEmail = user?.email || "developer@vaultticket.pro";
    ...
    >
      <div className="px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* COMING SOON BUTTON */}
          <button
            className={`hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium transition cursor-pointer ${
              dark
