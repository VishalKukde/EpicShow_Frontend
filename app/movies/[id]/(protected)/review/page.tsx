            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className={`mt-1 text-sm ${mode === "dark" ? "text-zinc-400" : "text-slate-500"}`}>
                  Verify seats, apply coupon, and continue to secure payment.
                </p>
              </div>
        ...
        <aside className={`h-fit rounded-3xl border p-5 shadow-sm lg:sticky lg:top-26 sm:p-6 ${mode === "dark" ? "border-zinc-700 bg-zinc-900" : "border-slate-200 bg-white"}`}>
          ...
          <div className="mt-4 space-y-3 text-sm">
            <div className={`flex items-center justify-between ${mode === "dark" ? "text-zinc-300" : "text-slate-600"}`}>
              <span>Movie</span>
              <span className={`max-w-[62%] truncate text-right font-medium ${mode === "dark" ? "text-zinc-100" : "text-slate-900"}`}>
                {item?.name || "-"}
              </span>
            </div>
            <div className={`flex items-center justify-between ${mode === "dark" ? "text-zinc-300" : "text-slate-600"}`}>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className={`flex items-center justify-between ${mode === "dark" ? "text-emerald-300" : "text-emerald-700"}`}>
              <span>Discount</span>
              <span>-₹{discount}</span>
            </div>
            {redeemReward && (
              <div className={`flex items-center justify-between ${mode === "dark" ? "text-emerald-300" : "text-emerald-700"}`}>
                <span>Reward Redeem</span>
