...
export default function TicketCard({ movie }: TicketCardProps) {
  ...
  return (
    <Link href={`/movies/${movie._id}`} className="group block">
      <div className="relative overflow-hidden rounded-[26px] border border-slate-200/80 bg-white p-2 shadow-[0_18px_40px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_26px_55px_rgba(15,23,42,0.12)] dark:border-zinc-800/80 dark:bg-zinc-900/90">
        <div className="relative overflow-hidden rounded-[20px]">
          <div className="relative h-[290px] sm:h-[300px] lg:h-[330px] overflow-hidden">
            ...
            <div className="absolute left-3 top-3 flex items-center gap-2">
              {isUpcoming ? (
                <span className="rounded-full border border-amber-400/50 bg-amber-500/35 px-2 py-1 text-[9px] font-bold uppercase tracking-[0.18em] text-amber-200 backdrop-blur-md shadow-sm">
                  Upcoming
                </span>
              ) : (
